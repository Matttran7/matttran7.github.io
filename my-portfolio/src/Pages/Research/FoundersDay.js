...
function FoundersDay() {
  return (
    <div className={styles.resumeContainer}>
      <Link to="/" className={styles.backButton}>
        Back
      </Link>
      <h2 style={{ textAlign: 'center', margin: '0.5rem 0 0' }}>Undergraduate Founder's Day</h2>
      ...
      <img
        src={require('./Cognitive_Agents_Research_Poster_Founders_Day.png')}
        alt="Undergraduate Founder's Day Poster"
